...
export const metadata: Metadata = {
  title: 'Gadgets | Tech Television',
  description: 'Reviews, lançamentos e novidades sobre os melhores gadgets e dispositivos tecnológicos.',
};
      ...
      <div className="bg-gradient-to-r from-[#CC0000] to-[#990000] text-white py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Gadgets</h1>
            <p className="text-xl md:text-2xl text-gray-100">
              Reviews, lançamentos e novidades sobre dispositivos tech
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <nav className="mb-6 text-sm">
            <ol className="flex items-center space-x-2 text-gray-600">
              ...
              <li>&gt;</li>
              <li className="text-[#CC0000] font-semibold">Gadgets</li>
            </ol>
          </nav>
